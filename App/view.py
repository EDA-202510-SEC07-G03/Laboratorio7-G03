...
def main():
    ...
    while working:
        ...
        if int(inputs[0]) == 1:
            ...
            author_book_list, tiempo_transcurrido, memoria_usada = logic.get_books_by_author(control, authorname)
            print_books_by_author(authorname,author_book_list, tiempo_transcurrido, memoria_usada)
